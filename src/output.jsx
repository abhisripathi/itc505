      ...
      <div>
        ...
        <article>
          <section>
            ...
            <ol>
              <li><strong>``</strong>: This declaration defines the document to be HTML5. It helps the browser to display the web page correctly.</li>
              <li><strong>``</strong>: This is the root element of the HTML document and specifies the language as English. It helps in accessibility and search engine optimization.</li>
              <li><strong>``</strong>: This container holds meta-information, links to stylesheets, and other resources. It's not directly visible to the user but vital for functionality and metadata.</li>
              ...
              <li><strong>`<h1>`, `</h1><h2>`, `</h2></strong><h3><strong>`</strong>: These are header tags, denoting different levels of headings in the document. They provide structure and help in accessibility.</h3></li>
              <li><strong>`</strong><address><strong>`</strong>: Specifies contact information for the author or owner of the document or article.</address></li>
              <li><strong>`</strong><section><strong>`</strong>: Represents a standalone section of content. Helps in structuring the document and making it more accessible.</section></li>
              <li><strong>`</strong><p><strong>`</strong>: Represents a paragraph of text.</p></li>
              <li><strong>`</strong><figure><strong>` and `</strong><figcaption><strong>`</strong>: Used together, they represent content like illustrations, diagrams, photos, or code listings alongside a caption.</figcaption></figure></li>
              <li><strong>`<a href="...">`</a></strong><a href="...">: Represents a hyperlink, which can lead to another webpage or can be used to create mailto links, as seen in the example.</a></li><a href="...">
                <li><strong>`</strong><ol><strong>`</strong>: Represents an ordered list. Perfect for listing references or other sequentially important items.
                  </ol>
                </li></a></ol></section><a href="...">
          </a></article><a href="...">
        </a></div>
    );
  }
